...
--- @param args? { options?: table<TheEncounter.DomainResolvable>, soulable?: boolean, ignore_everything?: boolean, ignore_in_pool?: boolean, ignore_once_per_run?: boolean, ignore_unique?: boolean, allow_repeats?: boolean, ignore_rarity?: boolean, rarity?: string | number | SMODS.Rarity, without_fallback?: boolean }
--- @param duplicates_list? table<string, boolean>
...
--- @param args? { options?: table<TheEncounter.DomainResolvable>, soulable?: boolean, ignore_everything?: boolean, ignore_in_pool?: boolean, ignore_once_per_run?: boolean, ignore_unique?: boolean, allow_repeats?: boolean, ignore_rarity?: boolean, rarity?: string | number | SMODS.Rarity, without_fallback?: boolean, increment_usage?: boolean }
--- @param duplicates_list? table<string, boolean>
...
--- @param domain TheEncounter.DomainResolvable
--- @param args? { options?: table<TheEncounter.ScenarioResolvable>, soulable?: boolean, ignore_everything?: boolean, ignore_in_pool?: boolean, ignore_once_per_run?: boolean, ignore_unique?: boolean, allow_repeats?: boolean, without_fallback?: boolean }
--- @param duplicates_list? table<string, boolean>
...
--- @param domain TheEncounter.DomainResolvable
--- @param args? { options?: table<TheEncounter.ScenarioResolvable>, soulable?: boolean, ignore_everything?: boolean, ignore_in_pool?: boolean, ignore_once_per_run?: boolean, ignore_unique?: boolean, allow_repeats?: boolean, without_fallback?: boolean, increment_usage?: boolean }
--- @param duplicates_list? table<string, boolean>
--- @return string | nil, boolean
