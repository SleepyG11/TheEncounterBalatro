...
--- @field private enter_step fun(self: TheEncounter.Event, func?: fun(), after_load?: boolean, after_scenario_start?: boolean)
--- @field private leave_step fun(self: TheEncounter.Event, func?: fun(), is_finish?: boolean)
